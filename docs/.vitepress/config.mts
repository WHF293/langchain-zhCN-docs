  ...
  themeConfig: {
    ...
    sidebar: {
      ...
      "/langgraph/": [
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: "Functional-API概述",
              link: "/langgraph/05-Functional-API概述",
            },
            { text: "Graph-API使用", link: "/langgraph/06-Graph-API使用" },
            {
              text: "Functional-API使用",
              link: "/langgraph/07-Functional-API使用",
            },
      ...
      "/other/": [
        ...
        {
          text: "deepagents 对比其他 agent",
          link: "/other/deepagents 对比 claude",
        },
      ],
    },
    ...
    // 社交链接
    socialLinks: [
      { icon: "github", link: "https://github.com/WHF293/langchain-zhCN-docs" },
    ],
    ...
    footer: {
      ...
      copyright: "© 2026 wanghaofeng LangChain 中文文档",
    },
